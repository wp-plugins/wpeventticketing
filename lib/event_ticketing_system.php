...
class eventTicketingSystem
{
	public function onInit() {
		add_action('admin_init', array( $this, "adminscripts"));
		add_action('wp_print_styles', array( $this, "frontendscripts"));
		add_action('admin_menu', array( $this, "options"));
		add_shortcode('wpeventticketing', array( $this, 'shortcode'));
		add_shortcode('wpeventticketingattendee', array( $this, 'attendeeShortcode'));
		add_action('template_redirect', array( $this, "paypal"));
		add_action('wpmu_new_blog',array( $this,"activate"),1);		
	}
